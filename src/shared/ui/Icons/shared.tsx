	...
	return function Icon(_props: IconProps) {
		return (
			<svg
				...
				width={_props.size === undefined ? 16 : _props.size}
				height={_props.size === undefined ? 16 : _props.size}
				viewBox={viewBox}
				fill="none"
				stroke="currentColor"
				stroke-width={1.75}
...
function svgIcon(
	...
	return function Icon(_props2: IconProps) {
		return (
			<svg
				aria-hidden="true"
				xmlns="http://www.w3.org/2000/svg"
				width={_props2.size === undefined ? 16 : _props2.size}
				height={_props2.size === undefined ? 16 : _props2.size}
				...
				stroke-width={options.stroke === null ? undefined : 1.75}
				stroke-linecap={options.stroke === null ? undefined : "round"}
				stroke-linejoin={options.stroke === null ? undefined : "round"}
				{...omit(_props2, "size")}
			>
				{children()}
			</svg>
