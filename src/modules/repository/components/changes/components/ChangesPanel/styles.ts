...
export const styles = stylex.create({
	...
	pathRow: {
		...
		containIntrinsicSize: `auto calc(${font.size_2} * 1.3 + ${controlSize._2} + 1px)`,
		alignItems: "center",
		gap: controlSize._2,
		borderLeftWidth: 2,
	...
	treeRow: {
		...
		display: "flex",
		contentVisibility: "auto",
		containIntrinsicSize: `auto calc(${controlSize._5} + 1px)`,
		height: `calc(${controlSize._5} + 1px)`,
		cursor: "pointer",
		alignItems: "center",
		gap: controlSize._1,
		borderLeftWidth: 2,
	...
	fileButton: {
		...
		textAlign: "left",
		fontSize: `calc(${font.size_2} + 1px)`,
		fontWeight: font.weight_5,
		lineHeight: `calc(${font.size_2} * 1.3 + 1px)`,
	},
	pathDirectory: {
		flex: "0 1 auto",
		minWidth: controlSize._0,
