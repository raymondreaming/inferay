...
import { saveWorkspacePanel } from "@workspace/services/workspaceApi.ts";
import {
	type Accessor,
	createMemo,
	createSignal,
...
export function panelQuery(workspaceId: string, send = saveWorkspacePanel) {
	return {
