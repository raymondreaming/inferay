...
import {
	...
	type SlashCommand,
	trimMessages,
} from "../../modules/conversation/agent-chat-shared.ts";
import {
	...
	loadPendingSend,
} from "../../modules/conversation/chat-session-store.ts";
import { serializeCommandSystemMessage } from "../../modules/conversation/command-system-message.ts";
