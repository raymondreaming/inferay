...
import type { CheckpointInfo } from "../../modules/conversation/agent-chat-shared.ts";
import {
	type CommandSystemMessage,
	parseCommandSystemMessage,
} from "../../modules/conversation/command-system-message.ts";
import {
	type GoalSystemMessage,
	parseGoalSystemMessage,
} from "../../modules/conversation/goal-system-message.ts";
